  ...
  return (
    <>
      ...
      <section id="hero" ref={heroRef} className="relative h-screen flex items-center overflow-hidden">
        <HeroSlideshow />
        <motion.div style={{ opacity: heroOpacity }} className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-32 md:pt-32 md:pb-40">
            ...
            <div>
              ...
              <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.6 }}
                ...
                <MagneticButton href={heroSection.ctaSecondary.href} strength={0.3}
                  className="px-10 py-5 bg-white/10 text-white rounded-xl font-bold text-lg border border-white/20 flex items-center gap-3 no-underline hover:bg-white/20">
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8, delay: 1.2 }}
                ...
                <div className="text-sm text-white/70"><span className="text-white font-semibold">200+</span> clientes confían en nosotros</div>
              </motion.div>
            </div>
      ...
      <section id="servicios" className="py-24 md:py-32 bg-femar-beige relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-20">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-femar-orange/15 text-femar-orange rounded-full text-sm font-semibold mb-6 border border-femar-orange/25">
            ...
            <p className="text-lg text-femar-navy/60 max-w-2xl mx-auto leading-relaxed">
              ...
              return (
                <AnimatedSection key={service.slug} delay={i * 0.12} className={isLarge ? 'md:col-span-2' : ''}>
                  <Link href={`/servicios/${service.slug}`} className="group block">
                    <div className={`bg-white/90 backdrop-blur-sm p-8 h-full relative overflow-hidden rounded-2xl shadow-sm border border-femar-navy/8 hover:shadow-lg hover:shadow-femar-orange/10 transition-all duration-500 ${isLarge ? 'min-h-[280px]' : 'min-h-[220px]'}`}>
                      ...
                      <div className="relative">
                        ...
                        <p className="text-femar-navy/50 leading-relaxed mb-6 text-sm md:text-base">
                          {service.description}
                        </p>
      ...
      {/* ========== ABOUT — LIGHT BACKGROUND, CLIENT COLORS ========== */}
      <section id="nosotros" className="py-24 md:py-32 bg-femar-beige relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection direction="left">
              ...
              <p className="text-lg text-femar-navy/60 leading-relaxed mb-10">
                {aboutData.story}
              </p>
                ...
                {aboutData.values.slice(0, 4).map((value, i) => {
                  ...
                  return (
                    <motion.div key={value.name}
                      className="bg-white/90 backdrop-blur-sm p-6 group relative overflow-hidden rounded-2xl shadow-sm border border-femar-navy/8 hover:shadow-lg hover:shadow-femar-orange/10 transition-all duration-300"
                      ...
                      <h4 className="font-bold text-femar-navy text-base mb-2">{value.name}</h4>
                      <p className="text-femar-navy/50 text-sm leading-relaxed">{value.description}</p>
                    </motion.div>
                  );
                })}
              </div>
      ...
      <section id="testimonios" className="py-24 md:py-32 bg-femar-light relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, i) => (
              <AnimatedSection key={testimonial.name} delay={i * 0.2}>
                <div className="bg-white/90 backdrop-blur-sm p-8 relative overflow-hidden rounded-2xl shadow-sm border border-femar-navy/8 hover:shadow-lg hover:shadow-femar-orange/10 transition-all duration-300 group">
                  ...
                  <p className="text-femar-navy/60 leading-relaxed mb-8 text-base italic">
                    {testimonial.text}
                  </p>
                  <div className="flex items-center gap-4 pt-6 border-t border-femar-navy/8">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-femar-navy/50">{testimonial.role} — {testimonial.company}</p>
                    </div>
                  </div>
                </div>
              </AnimatedSection>
      ...
      <section id="contacto-cta" className="py-24 md:py-32 bg-femar-navy relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          ...
          <AnimatedSection>
            ...
            <div className="flex flex-wrap justify-center gap-5">
              ...
              <MagneticButton href={siteConfig.whatsappLink} strength={0.3}
                className="px-10 py-5 bg-green-500/90 text-white rounded-xl font-bold text-lg shadow-lg shadow-green-500/30 flex items-center gap-3 no-underline hover:bg-green-500">

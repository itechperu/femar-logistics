...
export default function ServiceDetailClient({ service }: ServiceDetailClientProps) {
  ...
  return (
    <>
      ...
      <section className="relative pt-32 pb-24 md:pt-44 md:pb-32 bg-femar-navy overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 tracking-tight">{service.title}</h1>
            <p className="text-lg md:text-xl text-white/80 max-w-3xl">{service.description}</p>
      ...
      {/* Overview — LIGHT BEIGE */}
      <section id="overview" className="py-24 md:py-32 bg-femar-beige relative overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <div className="bg-white/95 p-10 md:p-14 max-w-4xl mx-auto relative overflow-hidden rounded-2xl shadow-sm border border-femar-navy/8">
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-femar-navy mb-8 tracking-tight">
                Sobre nuestro servicio de{"\n"}<span className="text-femar-orange">{service.title}</span>
              </h2>
              <p className="text-lg text-femar-navy/60 leading-relaxed">{service.fullDescription}</p>
            </div>
          </AnimatedSection>
        </div>
      </section>
      ...
      {/* Features — DARK NAVY */}
      <section id="features" className="py-24 md:py-32 bg-femar-navy relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {service.features.map((feature, i) => (
              <AnimatedSection key={feature} delay={i * 0.1}>
                <div className="bg-white/5 backdrop-blur-xl p-6 relative overflow-hidden group hover-glow rounded-2xl border border-white/10">
      ...
      {/* Benefits — LIGHT BEIGE */}
      <section id="benefits" className="py-24 md:py-32 bg-femar-beige relative overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {service.benefits.map((benefit, i) => (
              <AnimatedSection key={benefit} delay={i * 0.15}>
                <div className="bg-white/95 p-8 flex items-start gap-5 relative overflow-hidden group hover-glow rounded-2xl shadow-sm border border-femar-navy/8">
                  ...
                  <p className="text-femar-navy/60 leading-relaxed text-base font-medium">{benefit}</p>
                </div>
              </AnimatedSection>
            ))}
          </div>
      ...
      {/* CTA — DARK NAVY */}
      <section id="contact-service" className="py-24 bg-femar-navy relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">

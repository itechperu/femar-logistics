...
export default function BlogPageClient() {
  return (
    <>
      ...
      {/* Blog Grid */}
      <section id="articulos" className="py-24 md:py-32 mesh-gradient-section relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post, i) => (
              <AnimatedSection key={post.slug} delay={i * 0.15}>
                <article className="glass-card-light rounded-2xl overflow-hidden group hover-glow relative">
                  {/* Animated top border */}
                  ...
                  {/* Image placeholder */}
                  <div className="aspect-[16/10] mesh-gradient-hero relative overflow-hidden grid-pattern">
      ...
      {/* CTA */}
      <section className="py-24 mesh-gradient-hero grid-pattern relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
